...
//            .addClasses(AccountBean.class, AuthenticationBean.class, BookingBean.class, CampsiteBean.class, FavouriteListBean.class, SearchBean.class, SignUpBean.class)
...
////    @Inject
////    CampsiteBean campsiteBean;
////    @Inject
////    FavouriteListBean favouriteListBean;
////    @Inject
...
////        this.campsiteBean = new CampsiteBean();
...
//        Assert.assertEquals(camper, accountBean.searchCamper(usernameCamper));
//        user = signUpBean.saveUtilizador(camper, null, usernameCamper, "password");
//        Assert.assertEquals(user, accountBean.searchUtilizador(camper.getUsername()));
//    }
//    
////    @Test 
////    @InSequence(2)

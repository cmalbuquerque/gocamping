...
public class ServerCom {
     ...
     * Socket de escuta
     *
     * @serialField listeningSocket socket de escuta.
     */
     ...
     *
     * @serialField commSocket socket de comunicação
     */
     ...
     *
     * @serialField serverPortNumb port de escuta.
     */
     ...
     *
     * @serialField in entrada do canal de comunicação.
     */
     ...
     *
     * @serialField out saída do canal de comunicação
     */
     ...
     * @throws java.net.SocketTimeoutException Caso o socket demore muito e de timeout
     */
